...
>
> **Status:** the backend MVP is **complete and deployed** (release **v0.3.0** on Render, auto-deploy on push to `main`). 79 passing tests. The React frontend (`diagnostico-frontend`) is the remaining phase.
